  ...
  return (
    ...
    >
      ...
      <style>{`
        ...
        .story-modal-input::placeholder { color: #7b8494; }
        .story-modal-input:focus { border-color: #3b82f6; background: #101923; box-shadow: 0 0 0 3px rgba(59, 130, 246, 0.12); }
        .story-modal-input option { background: #0e1622; color: #e5e7eb; }
      `}</style>
    </div>
  );
}
